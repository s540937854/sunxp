...
from io1.bumo.model.response.result.BlockGetLatestValidatorsResult import BlockGetLatestValidatorsResult


class BlockGetLatestValidatorsResponse(BaseResponse):
    result = None  # type: BlockGetLatestValidatorsResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, BlockGetLatestValidatorsResult().parseDict(j))
                else:
