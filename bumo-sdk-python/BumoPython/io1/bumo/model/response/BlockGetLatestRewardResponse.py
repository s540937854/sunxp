...
from io1.bumo.model.response.result.BlockGetLatestRewardResult import BlockGetLatestRewardResult


class BlockGetLatestRewardResponse(BaseResponse):
    result = None  # type: BlockGetLatestRewardResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, BlockGetLatestRewardResult().parseDict(j))
                else:
