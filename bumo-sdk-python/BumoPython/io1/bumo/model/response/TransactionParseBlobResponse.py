...
from io1.bumo.model.response.result.TransactionParseBlobResult import TransactionParseBlobResult


class TransactionParseBlobResponse(BaseResponse):
    result = None  # type: TransactionParseBlobResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, TransactionParseBlobResult().parseDict(j))
                else:
