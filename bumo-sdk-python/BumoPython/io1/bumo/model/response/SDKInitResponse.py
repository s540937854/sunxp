...
from io1.bumo.model.response.result.SDKInitResult import SDKInitResult


class SDKInitResponse(BaseResponse):
    result = None  # type: SDKInitResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, SDKInitResponse().parseDict(j))
                else:
