...
from io1.bumo.model.response.result.BlockGetRewardResult import BlockGetRewardResult


class BlockGetRewardResponse(BaseResponse):
    result = None  # type: BlockGetRewardResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, BlockGetRewardResult().parseDict(j))
                else:
