...
from io1.bumo.model.response.result.ContractGetAddressResult import ContractGetAddressResult


class ContractGetAddressResponse(BaseResponse):
    result = None  # type: ContractGetAddressResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, ContractGetAddressResult().parseDict(j))
                else:
