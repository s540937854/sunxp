...
from io1.bumo.model.response.result.BlockGetValidatorsResult import BlockGetValidatorsResult


class BlockGetValidatorsResponse(BaseResponse):
    result = None  # type: BlockGetValidatorsResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, BlockGetValidatorsResult().parseDict(j))
                else:
