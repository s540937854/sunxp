...
from io1.bumo.model.response.result.AccountGetBalanceResult import AccountGetBalanceResult


class AccountGetBalanceResponse(BaseResponse):
    result = None  # type: AccountGetBalanceResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, AccountGetBalanceResult().parseDict(j))
                else:
