...
from io1.bumo.model.response.result.AssetGetInfoResult import AssetGetInfoResult


class AssetGetInfoResponse(BaseResponse):
    result = None  # type: AssetGetInfoResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, AssetGetInfoResult().parseDict(j))
                else:
