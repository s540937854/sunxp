...
from io1.bumo.model.response.result.BlockGetNumberResult import BlockGetNumberResult


class BlockGetNumberResponse(BaseResponse):
    result = None  # type: BlockGetNumberResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, BlockGetNumberResult().parseDict(j))
                else:
