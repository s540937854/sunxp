...
from io1.bumo.model.response.result.ContractCheckValidResult import ContractCheckValidResult


class ContractCheckValidResponse(BaseResponse):
    result = None  # type: ContractCheckValidResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, ContractCheckValidResult().parseDict(j))
                else:
