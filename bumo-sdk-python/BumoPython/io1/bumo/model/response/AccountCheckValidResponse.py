...
from io1.bumo.model.response.result.AccountCheckValidResult import AccountCheckValidResult


class AccountCheckValidResponse(BaseResponse):
    result = None  # type: AccountCheckValidResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, AccountCheckValidResult().parseDict(j))
                else:
