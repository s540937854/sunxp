...
from io1.bumo.model.response.result.TransactionSignResult import TransactionSignResult


class TransactionSignResponse(BaseResponse):
    result = None  # type: TransactionSignResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, TransactionSignResult().parseDict(j))
                else:
