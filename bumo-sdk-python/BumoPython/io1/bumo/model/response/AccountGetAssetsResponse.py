...
from io1.bumo.model.response.result.AccountGetAssetsResult import AccountGetAssetsResult


class AccountGetAssetsResponse(BaseResponse):
    result = None  # type: AccountGetAssetsResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, AccountGetAssetsResult().parseDict(j))
                else:
