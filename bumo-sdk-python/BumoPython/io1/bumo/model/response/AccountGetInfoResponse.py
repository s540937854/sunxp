...
from io1.bumo.model.response.result.AccountGetInfoResult import AccountGetInfoResult


class AccountGetInfoResponse(BaseResponse):
    result = None  # type: AccountGetInfoResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, AccountGetInfoResult().parseDict(j))
                else:
