...
from io1.bumo.model.response.result.BlockCheckStatusResult import BlockCheckStatusResult


class BlockCheckStatusResponse(BaseResponse):
    result = None  # type: BlockCheckStatusResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, BlockCheckStatusResult().parseDict(j))
                else:
