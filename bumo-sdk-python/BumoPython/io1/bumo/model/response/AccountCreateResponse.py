...
from io1.bumo.model.response.result.AccountCreateResult import AccountCreateResult


class AccountCreateResponse(BaseResponse):
    result = None  # type: AccountCreateResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, AccountCreateResult().parseDict(j))
                else:
