...
from io1.bumo.model.response.result.AccountGetMetadataResult import AccountGetMetadataResult


class AccountGetMetadataResult(BaseResponse):
    result = None  # type: AccountGetMetadataResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, AccountGetMetadataResult().parseDict(j))
                else:
