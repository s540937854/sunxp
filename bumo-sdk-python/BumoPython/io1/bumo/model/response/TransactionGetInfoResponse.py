...
from io1.bumo.model.response.result.TransactionGetInfoResult import TransactionGetInfoResult


class TransactionGetInfoResponse(BaseResponse):
    result = None  # type: TransactionGetInfoResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, TransactionGetInfoResult().parseDict(j))
                else:
