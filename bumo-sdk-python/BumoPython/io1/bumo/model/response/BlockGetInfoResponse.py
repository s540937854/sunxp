...
from io1.bumo.model.response.result.BlockGetInfoResult import BlockGetInfoResult


class BlockGetInfoResponse(BaseResponse):
    result = None  # type: BlockGetInfoResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, BlockGetInfoResult().parseDict(j))
                else:
