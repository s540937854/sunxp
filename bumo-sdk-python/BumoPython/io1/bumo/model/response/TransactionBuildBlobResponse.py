...
from io1.bumo.model.response.result.TransactionBuildBlobResult import TransactionBuildBlobResult


class TransactionBuildBlobResponse(BaseResponse):
    result = None  # type: TransactionBuildBlobResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, TransactionBuildBlobResult().parseDict(j))
                else:
