...
from io1.bumo.model.response.result.AccountCheckActivatedResult import AccountCheckActivatedResult


class AccountCheckActivatedResponse(BaseResponse):
    result = None  # type: AccountCheckActivatedResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, AccountCheckActivatedResult().parseDict(j))
                else:
