...
from io1.bumo.model.response.result.ContractGetInfoResult import ContractGetInfoResult


class ContractGetInfoResponse(BaseResponse):
    result = None  # type: ContractGetInfoResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, ContractGetInfoResult().parseDict(j))
                else:
