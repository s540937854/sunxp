...
from io1.bumo.model.response.result.BlockGetTransactionsResult import BlockGetTransactionsResult


class BlockGetTransactionsResponse(BaseResponse):
    result = None  # type: BlockGetTransactionsResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, BlockGetTransactionsResult().parseDict(j))
                else:
