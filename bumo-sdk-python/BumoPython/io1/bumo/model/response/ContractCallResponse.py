...
from io1.bumo.model.response.result.ContractCallResult import ContractCallResult


class ContractCallResponse(BaseResponse):
    result = None  # type: ContractCallResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, ContractCallResult().parseDict(j))
                else:
