...
from io1.bumo.model.response.result.TransactionEvaluateFeeResult import TransactionEvaluateFeeResult


class TransactionEvaluateFeeResponse(BaseResponse):
    result = None  # type: TransactionEvaluateFeeResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, TransactionEvaluateFeeResult().parseDict(j))
                else:
