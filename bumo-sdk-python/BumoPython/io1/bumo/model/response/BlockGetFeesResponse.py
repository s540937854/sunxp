...
from io1.bumo.model.response.result.BlockGetFeesResult import BlockGetFeesResult


class BlockGetFeesResponse(BaseResponse):
    result = None  # type: BlockGetFeesResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, BlockGetFeesResult().parseDict(j))
                else:
