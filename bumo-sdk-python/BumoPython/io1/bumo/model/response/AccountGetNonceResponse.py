...
from io1.bumo.model.response.result.AccountGetNonceResult import AccountGetNonceResult


class AccountGetNonceResponse(BaseResponse):
    result = None  # type: AccountGetNonceResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, AccountGetNonceResult().parseDict(j))
                else:
