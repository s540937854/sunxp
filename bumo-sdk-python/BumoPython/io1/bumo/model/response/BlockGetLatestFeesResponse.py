...
from io1.bumo.model.response.result.BlockGetLatestFeesResult import BlockGetLatestFeesResult


class BlockGetLatestFeesResponse(BaseResponse):
    result = None  # type: BlockGetLatestFeesResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, BlockGetLatestFeesResult().parseDict(j))
                else:
