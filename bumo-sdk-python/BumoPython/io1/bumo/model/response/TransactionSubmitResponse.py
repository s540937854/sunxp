...
from io1.bumo.model.response.result.TransactionSubmitResult import TransactionSubmitResult


class AccountCheckActivatedResponse(BaseResponse):
    result = None  # type: TransactionSubmitResult
    ...
    def parseDict(self, d):
        for i, j in d.items():
            if isinstance(j, dict):
                ...
                if i == 'result':
                    setattr(self, i, TransactionSubmitResult().parseDict(j))
                else:
